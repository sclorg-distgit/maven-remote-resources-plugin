%{?scl:%scl_package maven-remote-resources-plugin}
...
BuildRequires:  %{?scl_prefix}mvn(org.apache.maven.shared:maven-artifact-resolver)
...
BuildRequires:  %{?scl_prefix}mvn(org.apache.maven.shared:maven-verifier)
